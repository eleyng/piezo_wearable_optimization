...
for i = 3:1:37
    ...
    current_tot(i) = i_tot(i, dwarp, b, gweft, hpoly, hpiezo, L0, e31, kwarp, c, Ypoly, e33,n_warp);
    current_curv(i) = i_curv(i, b, hpoly, hpiezo, L0, e31, c, Ypoly, n_warp);
    current_tens(i) = i_tens(i, dwarp, gweft, hpoly, hpiezo, L0, e31, kwarp,  c,  Ypoly, n_warp);
    current_ac(i) = i_ac(i, b, hpoly, hpiezo, L0, e33, n_warp);
